            ...
            @foreach($animal as $type)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="#" class="btn btn-danger" data-toggle="modal" data-target="#delete{{$type->id}}">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    {!! Form::open(['action'=> ['Admin\PetTypeController@update', $type->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                    ...
                    <!-- Delete Modal -->
                    <div class="modal fade" id="delete{{$type->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <h1 class="text-center">Are you sure you want to delete <p style="color: red;">{{$type->name}}</p>?</h1>

                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
                                    {!!Form::open(['action' => ['Admin\PetTypeController@destroy', $type->id], 'method' => 'POST'])!!}
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['action'=> 'Admin\PetTypeController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                    <div class="form-group">
