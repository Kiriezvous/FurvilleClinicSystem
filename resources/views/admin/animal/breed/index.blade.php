            ...
            @foreach($Breed as $b)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="#" class="btn btn-danger" data-toggle="modal" data-target="#delete{{$b->id}}">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    {!! Form::open(['action'=> ['Admin\BreedController@update', $b->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                    ...
                    <div class="modal fade" id="delete{{$b->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <h1 class="text-center">Are you sure you want to delete <p style=" color: red;">{{$b->name}}</p>?</h1>

                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
                                    {!!Form::open(['action' => ['Admin\BreedController@destroy', $b->id], 'method' => 'POST'])!!}
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['action'=> 'Admin\BreedController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                    <div class="form-group">
                        {{Form::label('', 'Animal Type')}}
                        <select name="animaltype" class = 'form-control'>
