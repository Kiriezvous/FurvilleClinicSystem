          ...
          @foreach($posts as $s)
            <tr>
              ...
              <td>
                  ...
                  <a href="#" class="btn btn-danger" data-toggle="modal" data-target="#delete{{$s->id}}">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            {!! Form::open(['action'=> ['Admin\ServicesController@update', $s->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
            ...
            <div class="modal fade" id="delete{{$s->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <h1 class="text-center">Are you sure you want to delete <p style="color: red;">{{$s->service_name}}</p>?</h1>

                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
                            {!!Form::open(['action' => ['Admin\ServicesController@destroy', $s->id], 'method' => 'POST'])!!}
